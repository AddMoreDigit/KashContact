...
import { MyCampaignSchedulePage } from './components/user/MyCampaignSchedulePage';
...
import { UserTransactionsPage } from './components/user/UserTransactionsPage';
...
import { MessageChatPage } from './components/user/MessageChatPage';
...
import { ViewCampaignDetailPage } from './components/ViewCampaignDetailPage';
...
import { VendorCampaignsPage } from './components/vendor/VendorCampaignsPage';
import { VendorCampaignDetailPage } from './components/vendor/VendorCampaignDetailPage';
import { VendorServicesPage } from './components/vendor/VendorServicesPage';
import { VendorTransactionsPage } from './components/vendor/VendorTransactionsPage';
import { VendorOverviewPage } from './components/vendor/VendorOverviewPage';
import { VendorDraftsPage } from './components/vendor/VendorDraftsPage';
import { VendorHelpPage } from './components/vendor/VendorHelpPage';
import { VendorInvoicePage } from './components/vendor/VendorInvoicePage';
import { VendorReportPage } from './components/vendor/VendorReportPage';
import { ApproveBookingRequestPage } from './components/vendor/ApproveBookingRequestPage';
import { EditBookingPage } from './components/vendor/EditBookingPage';
import { VendorVouchersPage } from './components/vendor/VendorVouchersPage';

// Corporate Components
import { CorporateDashboard } from './components/corporate/CorporateDashboard';
import { CorporateCampaignsPage } from './components/corporate/CorporateCampaignsPage';
import { CorporateProfilePage } from './components/corporate/CorporateProfilePage';
import { CorporateCampaignDetailPage } from './components/corporate/CorporateCampaignDetailPage';
import { CorporateCampaignSchedulePage } from './components/corporate/CorporateCampaignSchedulePage';
import { CorporateTransactionsListPage } from './components/corporate/CorporateTransactionsListPage';
import { CorporateTransactionsPage } from './components/corporate/CorporateTransactionsPage';
import { CorporateVouchersPage } from './components/corporate/CorporateVouchersPage';
import { CorporateOverviewPage } from './components/corporate/CorporateOverviewPage';
import { CorporateDraftsPage } from './components/corporate/CorporateDraftsPage';
import { CorporateHelpPage } from './components/corporate/CorporateHelpPage';
import { CorporateGoalsTrackerPage } from './components/corporate/CorporateGoalsTrackerPage';
import { CorporateTransactionsTablePage } from './components/corporate/CorporateTransactionsTablePage';
import { CorporateSelectServicesPage } from './components/corporate/CorporateSelectServicesPage';
import { CorporateServiceProvidersPage } from './components/corporate/CorporateServiceProvidersPage';
...
export default function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'createCampaign':
        return <CreateCampaignPage onNavigate={setCurrentPage} cartItems={cartItems} onClearCart={() => { setCartItems([]); setEditingDraft(null); }} draftData={editingDraft} onCreateCampaign={handleCreateCampaign} />;
      case 'manageCampaign':
