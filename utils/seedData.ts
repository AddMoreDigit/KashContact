...
export const SEED_CAMPAIGNS: Campaign[] = [
  {
    ...
    creatorEmail: SEED_MEMBERS.michael.email,
    adminEmails: [SEED_MEMBERS.michael.email, SEED_MEMBERS.sarah.email, SEED_MEMBERS.currentUser.email],
    ...
    numberOfMembers: 6,
    members: [
      { name: SEED_MEMBERS.currentUser.name, email: SEED_MEMBERS.currentUser.email, avatar: SEED_MEMBERS.currentUser.avatar },
  ...
  },
  {
    ...
    creatorEmail: SEED_MEMBERS.sarah.email,
    adminEmails: [SEED_MEMBERS.sarah.email],
  ...
  },
  {
    ...
    creatorEmail: SEED_MEMBERS.david.email,
    adminEmails: [SEED_MEMBERS.david.email],
  ...
  },
  {
    ...
    creatorEmail: SEED_MEMBERS.emma.email,
    adminEmails: [SEED_MEMBERS.emma.email, SEED_MEMBERS.michael.email, SEED_MEMBERS.currentUser.email],
  ...
  },
  {
    ...
    creatorEmail: SEED_MEMBERS.john.email,
    adminEmails: [SEED_MEMBERS.john.email],
