...
export function ProfilePage({ className, userProfile, onUpdateProfile }: ProfilePageProps) {
  ...
  const [editBankDetails, setEditBankDetails] = useState(userProfile.bankDetails || {
    accountHolder: '',
    accountNumber: '',
    bankName: ''
  });
  ...
  const handleSavePhoto = () => {
    ...
    if (finalPhotoUrl) {
      console.log('Saving photo:', finalPhotoUrl.substring(0, 50) + '...');
  ...
  const handleSaveBankDetails = () => {
    const updatedProfile = { ...userProfile, bankDetails: editBankDetails };
    onUpdateProfile(updatedProfile);
    ...
    <div className={`bg-[#f5f5f5] min-h-screen pb-20 ${className || ''}`}>
      ...
      <div className="relative">
        ...
        <div className="absolute left-8 -bottom-16 w-32 h-32 rounded-full border-4 border-white overflow-hidden bg-white">
          <img 
            key={userProfile.photo || 'default'} 
            src={userProfile.photo || imgEllipse45} 
            alt="Profile" 
            className="w-full h-full object-cover"
          />
      ...
      <div className="pt-20 px-8 max-w-[1400px] mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button 
              onClick={() => setShowEditPersonalInfo(true)}
              className="text-[#8363f2] hover:underline text-[14px]"
            >
              Edit
            </button>
          </div>
          ...
          <div className="space-y-3 text-[14px]">
            ...
            <div className="text-gray-600">Surname</div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-[14px] text-gray-800">Off</span>
            </div>
            <div className="flex items-center justify-between">
        ...
        <DialogContent className="max-w-[600px]">
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                id="twoFactor"
                checked={editSecurityInfo.twoFactorAuth}
                onCheckedChange={(checked) => setEditSecurityInfo({ ...editSecurityInfo, twoFactorAuth: checked })}
              />
            </div>
            <div className="space-y-2">
        ...
        <DialogContent className="max-w-[700px]">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              disabled={!croppedImage && !photoPreview}
      ...
      <Dialog open={showBankDetails} onOpenChange={setShowBankDetails}>
        <DialogContent className="max-w-[600px]">
          ...
          <DialogDescription>Update your bank details below</DialogDescription>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setEditBankDetails({ ...editBankDetails, accountHolder: e.target.value })}
              />
            </div>
            <div className="space-y-2">
