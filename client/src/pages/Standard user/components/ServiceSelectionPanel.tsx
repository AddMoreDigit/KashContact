  ...
  return (
    <>
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent side="right" className="w-full sm:max-w-2xl p-0 overflow-y-auto [&>button]:hidden">
          <SheetHeader className="sr-only">
            <SheetTitle>Select Services</SheetTitle>
            <SheetDescription>Choose services for your campaign</SheetDescription>
          </SheetHeader>
      ...
      <Dialog open={showBookingDialog} onOpenChange={setShowBookingDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              R{selectedRoom?.price.toLocaleString()} Per Night
            </DialogDescription>
          </DialogHeader>
          
          <div className="py-4">
            <h4 className="text-sm text-gray-700 mb-3">Select Check-in Date</h4>
