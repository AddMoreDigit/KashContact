...
import { CampaignCompletedDialog } from './CampaignCompletedDialog';
...
export function CampaignDetailPage({ onNavigate }: CampaignDetailPageProps) {
  ...
  const serviceProviders = [
    { name: 'Gold Reef Hotel', icon: '🏨' },
    { name: 'Reef City Catering', icon: '🍽️' },
    { name: 'Reef Casino', icon: '🎰' },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-gray-900">Gold reef city - Team Building Weekend</h1>
            <div className="flex items-center gap-2 text-gray-600">
              <Calendar size={14} />
              <span>October 1,2025 - November 2,2025</span>
            </div>
          </div>
        </div>
