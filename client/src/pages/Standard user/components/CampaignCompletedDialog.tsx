    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
          ...
          {/* Title */}
          <DialogTitle className="text-gray-900 mb-2">Great Job</DialogTitle>

          {/* Description */}
          <DialogDescription className="text-gray-600 mb-8">Your Campaign is Completed</DialogDescription>
