import svgPaths from "./svg-1xmlscs5x6";
...
function Group2() {
  return (
    <div className="absolute inset-[78.42%_60.56%_19.24%_37.78%]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group 23">
...
function Button7() {
  return (
    <div className="absolute bg-[#8363f2] box-border content-stretch flex gap-[8px] items-center left-[calc(75%+21px)] min-h-[56px] px-[24px] py-[12px] rounded-[8px] top-[934px] w-[284px]" data-name="Button">
      <Text6 />
    </div>
  );
}
...
function Button8() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] h-[56px] items-center left-[calc(58.333%+81px)] px-[24px] py-[12px] rounded-[5px] top-[934px] w-[170px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#8363f2] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[5px]" />
      <Text7 />
    </div>
  );
...
export default function DashBoard22NormalUserCampaignsHistory() {
  return (
    <div className="bg-white relative size-full" data-name="Dash board 22 Normal userCampaigns History">
      ...
      <Group2 />
      <div className="absolute inset-[79%_79.79%_18.65%_18.54%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
