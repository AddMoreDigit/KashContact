...
import imgRectangle115Food from 'figma:asset/87102388d503206b3b0fb177ad63642a9945094b.png';
import imgRectangle612Food from 'figma:asset/d3d1c2b311cd5ffbc7e046f0234a084279bf69e2.png';
import imgRectangle150Food from 'figma:asset/840a8d2b23fcae6efd3c33d28ca3649c5eda74ed.png';

// Import Transport tab images
import imgRectangle115Transport from 'figma:asset/fe7de853845217d9c1290dc5830a36edf532801b.png';
import imgRectangle148Transport from 'figma:asset/703a3a22134188eeed9837e5755d43d8e16d5f2f.png';
import imgRectangle150Transport from 'figma:asset/dcaf59de9dc3fbd4c71a055baaafd59cadfc1096.png';

// Import Activities tab images
import imgRectangle115Activities from 'figma:asset/2cd0806b75ceaec4ce1353812cc2f2eb82fde8f2.png';
import imgRectangle148Activities from 'figma:asset/6a4cb1a71759404169c3e112082d2c3714560afd.png';
import imgRectangle150Activities from 'figma:asset/c7aad628ae96a153d38a7f65ffdeb84cab179b40.png';
...
export function ServiceDetailPage({ onNavigate, onShowSelectCampaign, service, cartItems = [], onUpdateCart, onShowNotifications, hasUnreadNotifications, onShowCart }: ServiceDetailPageProps) {
  ...
  const getHeroImage = () => {
    switch (activeTab) {
      case 'food':
        return imgRectangle115Food;
      case 'transport':
        return imgRectangle115Transport;
      case 'activities':
        return imgRectangle115Activities;
      default:
        return service?.image || imgRectangle115;
    }
  };
  ...
  const transportOptions: ServiceItem[] = [
    {
      ...
      description: 'Spacious Double room\nwith garden view',
      price: 'R1 500',
      image: imgRectangle148Transport,
    },
    {
      id: 2,
      name: 'Deluxe Room',
      description: 'Spacious Double room\nwith garden view',
      price: 'R2 500',
      image: imgRectangle150Transport,
    },
  ];
  ...
  const activitiesOptions: ServiceItem[] = [
    {
      ...
      description: 'Spacious Double room\nwith garden view',
      price: 'R1 500',
      image: imgRectangle148Activities,
    },
    {
      id: 2,
      name: 'Deluxe Room',
      description: 'Spacious Double room\nwith garden view',
      price: 'R2 500',
      image: imgRectangle150Activities,
    },
  ];
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          onClick={() => handleBookRoom({
                            ...
                            price: `R${room.priceRate || room.price}`,
                            image: room.image
                          })}
                          disabled={isBooked}
                          className={`px-8 ${
