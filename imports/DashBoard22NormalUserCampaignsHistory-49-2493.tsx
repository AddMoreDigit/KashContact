import svgPaths from "./svg-yul0kernwp";
...
function ProfileAvatar() {
  return (
    <div className="absolute left-[calc(91.67%+53px)] size-[24px] top-[47px]" data-name="Profile Avatar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
...
function Group7() {
  return (
    <div className="absolute contents left-[calc(16.67%+30px)] top-[433px]">
      <div className="absolute bg-[#eeeeee] h-[29px] left-[calc(16.67%+30px)] rounded-[8px] top-[433px] w-[31.762px]" />
      <Group3 />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] h-[56px] items-center left-[calc(16.67%+29px)] px-[24px] py-[12px] rounded-[5px] top-[584px] w-[1104px]" data-name="Button">
...
function Button3() {
  return (
    <div className="absolute bg-[rgba(131,99,242,0.05)] box-border content-stretch flex gap-[8px] h-[56px] items-center left-[calc(16.67%+31px)] px-[24px] py-[12px] rounded-[5px] top-[675px] w-[144px]" data-name="Button">
...
function Button5() {
  return (
    <div className="absolute bg-[rgba(131,99,242,0.05)] box-border content-stretch flex gap-[8px] h-[56px] items-center left-[calc(41.67%+5px)] px-[24px] py-[12px] rounded-[5px] top-[675px] w-[144px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[0.5px] border-[rgba(131,99,242,0.1)] border-solid inset-0 pointer-events-none rounded-[5px]" />
      <Text4 />
    </div>
  );
...
function Button8() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] h-[56px] items-center left-[calc(58.33%+81px)] px-[24px] py-[12px] rounded-[5px] top-[934px] w-[170px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#8363f2] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[5px]" />
      <Text7 />
    </div>
  );
...
export default function DashBoard22NormalUserCampaignsHistory() {
  return (
    <div className="bg-white relative size-full" data-name="Dash board 22 Normal userCampaigns History">
      ...
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[82px] left-[calc(16.67%+31px)] not-italic text-[32px] text-black text-nowrap top-[15px] tracking-[-0.32px] whitespace-pre">Contribute</p>
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[82px] left-[calc(16.67%+30px)] not-italic text-[#1b1b1b] text-[24px] text-nowrap top-[332px] tracking-[-0.32px] whitespace-pre">Gold Reef City Weekend</p>
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(16.67%+64px)] not-italic text-[#212020] text-[20px] text-nowrap top-[407px] tracking-[-0.32px] whitespace-pre">Goal R10 000</p>
      <Group7 />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[82px] left-[calc(91.67%+28px)] not-italic text-[20px] text-black text-nowrap top-[435px] tracking-[-0.32px] whitespace-pre">15%</p>
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[82px] left-[calc(16.67%+30px)] not-italic text-[28px] text-black text-nowrap top-[512px] tracking-[-0.32px] whitespace-pre">Enter Amount (ZAR)</p>
      <Button2 />
      <Button3 />
      <Button4 />
      <Button5 />
      <Button6 />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[82px] left-[calc(16.67%+32px)] not-italic text-[28px] text-black text-nowrap top-[717px] tracking-[-0.32px] whitespace-pre">Payment Methods</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(16.67%+61px)] not-italic text-[24px] text-black text-nowrap top-[776px] tracking-[-0.32px] whitespace-pre">Ewallent Balance</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(33.33%+100px)] not-italic text-[24px] text-black text-nowrap top-[774px] tracking-[-0.32px] whitespace-pre">{`Debit Card `}</p>
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(16.67%+63px)] not-italic text-[0px] text-[20px] text-black text-nowrap top-[871px] tracking-[-0.32px] whitespace-pre">
