import svgPaths from "./svg-fbaea97tes";
...
import imgRectangle349 from "../../imports/figma/asset/"a3825e566b26b37668a63ccc1ccf01de1ed9f478.png";
...
function Input() {
  return (
    <div className="absolute bg-[#f5f5fa] h-[64px] left-[calc(16.667%+27px)] overflow-clip rounded-[20px] top-[21px] w-[360px]" data-name="Input">
...
function ProfileAvatar() {
  return (
    <div className="absolute left-[calc(91.667%+46px)] size-[24px] top-[43px]" data-name="Profile Avatar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
...
function Button1() {
  return (
    <div className="absolute bg-[#8363f2] box-border content-stretch flex gap-[8px] items-center left-[calc(66.667%+104px)] min-h-[56px] px-[24px] py-[12px] rounded-[8px] top-[27px] w-[150px]" data-name="Button">
      <Text />
    </div>
  );
}
...
function Group3() {
  return (
    <div className="absolute contents left-[calc(66.667%+104px)] top-[27px]">
      <Button1 />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] items-center left-[calc(83.333%+40px)] min-h-[56px] px-[24px] py-[12px] rounded-[8px] top-[478px] w-[150px]" data-name="Button">
...
function Button3() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] items-center left-[calc(66.667%+92px)] min-h-[56px] px-[24px] py-[12px] rounded-[8px] top-[478px] w-[176px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#8363f2] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Button4() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] items-center justify-center left-[calc(54.167%+34px)] min-h-[56px] px-[24px] py-[12px] rounded-[8px] top-[1174px] translate-x-[-50%] w-[174px]" data-name="Button">
...
function Menu() {
  return (
    <div className="absolute contents left-0 top-[139px]" data-name="Menu">
      ...
      <MaskGroup />
      <div className="absolute inset-[15.98%_95.9%_82.23%_2.43%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
...
export default function DashBoard1NormalUserCampaigns() {
  return (
    <div className="bg-white relative size-full" data-name="Dash board 1 normal user campaigns">
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*1)+(var(--transform-inner-height)*0)))] items-center justify-center left-[calc(8.333%+62.5px)] top-[33px] w-[calc(1px*((var(--transform-inner-height)*1)+(var(--transform-inner-width)*0)))]" style={{ "--transform-inner-width": "22", "--transform-inner-height": "0" } as React.CSSProperties}>
      ...
      <Input />
      <ProfileAvatar />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(29.167%-153px)] not-italic text-[32px] text-black text-nowrap top-[463px] tracking-[-0.32px] whitespace-pre">Service Providers</p>
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.9999879598617554)+(var(--transform-inner-height)*0.004905943293124437)))] items-center justify-center left-[calc(16.667%+27px)] top-[858px] w-[calc(1px*((var(--transform-inner-height)*0.9999879598617554)+(var(--transform-inner-width)*0.004905943293124437)))]" style={{ "--transform-inner-width": "268.078125", "--transform-inner-height": "353.84375" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.9999879598617554)+(var(--transform-inner-height)*0.004905943293124437)))] items-center justify-center left-[calc(16.667%+25px)] top-[552px] w-[calc(1px*((var(--transform-inner-height)*0.9999879598617554)+(var(--transform-inner-width)*0.004905943293124437)))]" style={{ "--transform-inner-width": "268.078125", "--transform-inner-height": "353.40625" } as React.CSSProperties}>
        <div className="flex-none rotate-[270.281deg]">
          <div className="bg-white h-[353.418px] rounded-[8px] shadow-[0px_4px_6px_1px_rgba(95,94,96,0.25)] w-[268.092px]" />
        </div>
      </div>
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.9999879598617554)+(var(--transform-inner-height)*0.004905943293124437)))] items-center justify-center left-[calc(41.667%+50.996px)] top-[855px] w-[calc(1px*((var(--transform-inner-height)*0.9999879598617554)+(var(--transform-inner-width)*0.004905943293124437)))]" style={{ "--transform-inner-width": "268.921875", "--transform-inner-height": "350.1875" } as React.CSSProperties}>
        <div className="flex-none rotate-[270.281deg]">
          <div className="bg-white h-[350.208px] rounded-[8px] shadow-[0px_4px_6px_1px_rgba(95,94,96,0.25)] w-[268.932px]" />
        </div>
      </div>
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.9999879598617554)+(var(--transform-inner-height)*0.004905943293124437)))] items-center justify-center left-[calc(41.667%+50.996px)] top-[549px] w-[calc(1px*((var(--transform-inner-height)*0.9999879598617554)+(var(--transform-inner-width)*0.004905943293124437)))]" style={{ "--transform-inner-width": "268.921875", "--transform-inner-height": "352.46875" } as React.CSSProperties}>
        <div className="flex-none rotate-[270.281deg]">
          <div className="bg-white h-[352.475px] rounded-[8px] shadow-[0px_4px_6px_1px_rgba(95,94,96,0.25)] w-[268.932px]" />
        </div>
      </div>
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.9999879598617554)+(var(--transform-inner-height)*0.004905943293124437)))] items-center justify-center left-[calc(66.667%+88.001px)] top-[856px] w-[calc(1px*((var(--transform-inner-height)*0.9999879598617554)+(var(--transform-inner-width)*0.004905943293124437)))]" style={{ "--transform-inner-width": "267.953125", "--transform-inner-height": "351.78125" } as React.CSSProperties}>
        <div className="flex-none rotate-[270.281deg]">
          <div className="bg-white h-[351.796px] rounded-[8px] shadow-[0px_4px_6px_1px_rgba(95,94,96,0.25)] w-[267.96px]" />
        </div>
      </div>
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.9999879598617554)+(var(--transform-inner-height)*0.004905943293124437)))] items-center justify-center left-[calc(66.667%+79.001px)] top-[550px] w-[calc(1px*((var(--transform-inner-height)*0.9999879598617554)+(var(--transform-inner-width)*0.004905943293124437)))]" style={{ "--transform-inner-width": "267.953125", "--transform-inner-height": "351.3125" } as React.CSSProperties}>
        <div className="flex-none rotate-[270.281deg]">
          <div className="bg-white h-[351.327px] rounded-[8px] shadow-[0px_4px_6px_1px_rgba(95,94,96,0.25)] w-[267.96px]" />
        </div>
      </div>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(16.667%+50.573px)] not-italic text-[20px] text-black text-nowrap top-[1056px] tracking-[-0.32px] whitespace-pre">Cape town /accomodation</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(16.667%+58.573px)] not-italic text-[20px] text-black text-nowrap top-[746px] tracking-[-0.32px] whitespace-pre">Durban /accommodation</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(41.667%+102.573px)] not-italic text-[20px] text-black text-nowrap top-[1050px] tracking-[-0.32px] whitespace-pre">Durban food service</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(41.667%+82.573px)] not-italic text-[20px] text-black text-nowrap top-[744px] tracking-[-0.32px] whitespace-pre">{`Durban | food service & Motel`}</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(75%+11.573px)] not-italic text-[20px] text-black text-nowrap top-[1046px] tracking-[-0.32px] whitespace-pre">Zanzibar/Accommodation</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[82px] left-[calc(66.667%+112.573px)] not-italic text-[20px] text-black text-nowrap top-[740px] tracking-[-0.32px] whitespace-pre">Cape town /Accommodation</p>
      <Group4 />
      <div className="absolute h-[155px] left-[calc(16.667%+29px)] rounded-tl-[8px] rounded-tr-[8px] top-[859px] w-[352px]">
      ...
      <div className="absolute h-[155px] left-[calc(16.667%+27px)] rounded-tl-[8px] rounded-tr-[8px] top-[553px] w-[352px]">
      ...
      <div className="absolute h-[155px] left-[calc(41.667%+52px)] rounded-tl-[8px] rounded-tr-[8px] top-[855px] w-[352px]">
      ...
      <div className="absolute h-[155px] left-[calc(41.667%+52px)] rounded-tl-[8px] rounded-tr-[8px] top-[549px] w-[352px]">
      ...
      <div className="absolute h-[155px] left-[calc(66.667%+88px)] rounded-tl-[8px] rounded-tr-[8px] top-[860px] w-[352px]">
      ...
      <div className="absolute h-[155px] left-[calc(66.667%+79px)] rounded-tl-[8px] rounded-tr-[8px] top-[554px] w-[352px]">
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[82px] left-[calc(29.167%-114.427px)] not-italic text-[32px] text-black text-nowrap top-[1009px] tracking-[-0.32px] whitespace-pre">Seaview Lodge</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[82px] left-[calc(29.167%-129.427px)] not-italic text-[32px] text-black text-nowrap top-[703px] tracking-[-0.32px] whitespace-pre">Blue Water Hotel</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[82px] left-[calc(54.167%-119.427px)] not-italic text-[32px] text-black text-nowrap top-[1009px] tracking-[-0.32px] whitespace-pre">Tastebites catering</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[82px] left-[calc(54.167%-99px)] not-italic text-[32px] text-black text-nowrap top-[705px] tracking-[-0.32px] whitespace-pre">Lekkeslaap</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[82px] left-[calc(83.333%-105.427px)] not-italic text-[32px] text-black text-nowrap top-[1007px] tracking-[-0.32px] whitespace-pre">{`Island paradise `}</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[82px] left-[calc(83.333%-130px)] not-italic text-[32px] text-black text-nowrap top-[701px] tracking-[-0.32px] whitespace-pre">Cape town Beach</p>
      <Button2 />
      <Button3 />
      ...
      <div className="absolute h-[303px] left-[calc(16.667%+60px)] top-[153px] w-[1059px]">
      ...
      <div className="absolute flex h-0 items-center justify-center left-[calc(8.333%+102px)] top-[111px] w-[1234px]">
        <div className="flex-none rotate-[180deg]">
