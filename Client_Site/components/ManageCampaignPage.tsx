...
import { ChevronLeft, Edit, Star, Plus, X } from 'lucide-react';
...
import campaignHeroImg from 'figma:asset/739a2f9aab629427ec990dc7f235cb52f6b02dcc.png';
...
export function ManageCampaignPage({ onNavigate, campaign, onUpdateCampaign }: ManageCampaignPageProps) {
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              <div className="flex items-center gap-2 text-gray-700 mb-1">
                ...
                <span>Goal: R{activeCampaign.goal.toLocaleString()}.00</span>
              </div>
            ...
            <div className="text-right">
              <div className="text-gray-900 mb-1">Contributed: R{activeCampaign.contributed.toLocaleString()}.00</div>
        ...
        <div className="bg-white rounded-lg p-6 mb-6">
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            <div>
              ...
              <div className="text-gray-900">R{activeCampaign.goal.toLocaleString()}</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-gray-900">R{(activeCampaign.goal / displayMembers.length).toLocaleString()}</div>
            </div>
            <div>
              <div className="text-sm text-gray-600 mb-1">Total Member Targets</div>
              <div className="text-purple-600">R{activeCampaign.goal.toLocaleString()}</div>
            </div>
          </div>
