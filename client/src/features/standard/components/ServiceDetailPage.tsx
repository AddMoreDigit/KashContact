...
const heroImage = "https://via.placeholder.com/400x300?text=Image";
const transportHero = "https://via.placeholder.com/400x300?text=Image";
const activitiesHero = "https://via.placeholder.com/400x300?text=Image";
