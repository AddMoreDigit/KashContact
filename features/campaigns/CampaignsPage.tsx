...
//import * as svgPaths from "../../components/icons/svgPaths"; 
...
export function CampaignsPage({ onNavigate, onShowNotifications, createdCampaigns = [], onSelectCampaign, hasUnreadNotifications, onShowCart }: CampaignsPageProps) {
  ...
  return (
    <div className="flex-1 bg-white">
      ...
      {/* Campaigns List - Single Column Full Width */}
            ...
            return (
              ...
              >
                ...
                <div className="relative h-64">
                  ...
                  />
                  {/* Contribute/Manage Button - Top Right */}
                  {!isDeclined && (
                    <div className="absolute top-4 right-8">
                      {campaign.status === 'contribute' ? (
                        <Button
                          ...
                          disabled={isPending || storageStatus !== 'accepted'}
                          className="bg-[#2d1b69] hover:bg-[#2d1b69]/90 text-white px-6 py-3 h-auto disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          Contribute
                        </Button>
                      ) : (
                ...
                <div className="p-6">
                  ...
                  {/* View Campaign Link - Bottom Right */}
