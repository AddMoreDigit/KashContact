...
import { RemoveContributorDialog } from './components/RemoveContributorDialog';
import { ReplaceContributorDialog } from './components/ReplaceContributorDialog';
import { RefundContributorDialog } from './components/RefundContributorDialog';
...
export function ContributorDetailPage({ onNavigate, member, campaign, onRemoveMember, onReplaceMember, onRefundMember, onShowNotifications, hasUnreadNotifications, onShowCart }: ContributorDetailPageProps) {
  ...
  const contributorData = member ? {
    ...
    email: member.email,
    avatar: member.avatar || "/asset/e44d5cd688ebcf29969455cdd422abc0ede80023.png" ,
    ...
    avatar: "/asset/e44d5cd688ebcf29969455cdd422abc0ede80023.png",
