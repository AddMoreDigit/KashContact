...
export default function ProjectWrapper({ selectedRole, onLoginSuccess, onNavigateToSignUp }: ProjectWrapperProps) {
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="bg-black text-white p-12 w-full max-w-[320px] min-h-[420px] flex flex-col justify-center">
              <div className="ml-8">
                ...
                <p className="text-sm">Please continue Logging in as {getRoleDisplayName()}</p>
              </div>
            </div>
          </div>
        </div>
