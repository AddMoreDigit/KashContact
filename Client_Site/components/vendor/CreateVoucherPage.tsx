...
export function CreateVoucherPage({ open, onOpenChange, onCreateVoucher, onNavigate }: CreateVoucherPageProps) {
  ...
  return (
    <div className="fixed inset-0 bg-white z-50 flex">
      {/* Sidebar */}
      <VendorSidebar currentPage="vouchers" onNavigate={onNavigate} />
